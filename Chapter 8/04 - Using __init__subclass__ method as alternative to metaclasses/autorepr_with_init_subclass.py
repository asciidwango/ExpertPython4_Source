...
class MyFurtherChildClass(MyChildClass):
    attr_e: Any
...
if __name__ == "__main__":
    print(MyClass("究極の疑問の答え", 42))
    print(MyClass([1, 2, 3], ["a", "b", "c"]))
    print(MyChildClass("究極の疑問の答え", 42))
    print(MyChildClass([1, 2, 3], ["a", "b", "c"]))
    print(MyFurtherChildClass("究極の疑問の答え", 42))
    print(MyFurtherChildClass([1, 2, 3], ["a", "b", "c"]))
